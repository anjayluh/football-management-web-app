...
function show_fixtures($names) { 
    ...
    print "<p class = 23>Fixtures for $teams teams.</p>";
    ...
    // Benjamin akera:: i have put my table code here;;;
...
function flip($match) {
    $components = preg_split("/\s*v\s*/", $match);
